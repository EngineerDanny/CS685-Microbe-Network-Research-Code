...
## The paramters that I want to pass from the command line are:
## 1. The fold index that I want to use to split the data into train and test. 
##    The rows with fold ID will be used as the test set whilst the rest will be used as the train set.
## 2. The column range that I want to use for prediction.
...
# gg.save("./code/my_lasso_facetted_w8.png")
