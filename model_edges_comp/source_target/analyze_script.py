...
for dataset in dataset_list:
    ...
    for n_samples in n_samples_list:
        ...
        # find the median, max and min of the weight column using the source and target columns
        test_err_df = test_err_df.groupby(["source", "target"]).agg([np.median, np.max, np.min]).reset_index()
