- Trying to reproduce the [figure](https://rcdata.nau.edu/genomic-ml/necromass/data-danny-same-other-cv-figure.png) results of when used on necromass data set with Featureless and LassoCV in python.
